...
from catalog.forms import RenewBookFormModel
...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_name='Christina %s' % author_num, last_name = 'Surname %s' % author_num)
...
class LoanedBookInstancesByUserListViewTes(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        #Check we used correct templete
    ...
    def renew_book_librarian(request, pk):
        ...
        # if this is a GET (or any other method) create the default form
            ...
            form = RenewBookFormModel(initial={'renewl_date': proposal_renewal_date,})
